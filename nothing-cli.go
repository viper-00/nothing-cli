...
func main() {
	var (
		localPort = flag.Int("port", 0, "Local port to listen on, default to pick a random port")
		localHost = flag.String("host", "localhost", "Local address to listen on")
		remote    = flag.String("r", "", "Random address(host:port) to connect")
